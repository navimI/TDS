...
public class VentanaLoginRegistro {
	...
	private void initialize() {
		...
		frmAppmusic.setBounds(100, 100, 600, 600);
		...
		gbl_panelFormularioLogin.columnWidths = new int[]{15, 0, 0, 0, 0, 15, 0};
		gbl_panelFormularioLogin.rowHeights = new int[]{0, 0, 0, 0, 0, 0};
		gbl_panelFormularioLogin.columnWeights = new double[]{1.0, 1.0, 1.0, 0.0, 1.0, 1.0, Double.MIN_VALUE};
		gbl_panelFormularioLogin.rowWeights = new double[]{0.0, 0.0, 0.0, 1.0, 1.0, Double.MIN_VALUE};
