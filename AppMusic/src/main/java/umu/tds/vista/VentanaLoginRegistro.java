...
public class VentanaLoginRegistro {
	...
	private void initialize() {
		...
		JPanel panelIdLogin = new JPanel();
		GridBagConstraints gbc_panelIdLogin = new GridBagConstraints();
		gbc_panelIdLogin.fill = GridBagConstraints.HORIZONTAL;
		panelLogin.add(panelIdLogin, gbc_panelFormulario);
		...
		//Panel para el registro usandolo el panel como si fuera una card layout
